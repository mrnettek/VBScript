' Description: Demonstration script that searches for all Accountants in the fabrikam.com domain and then adds all those user accounts to the Accountants security group.
