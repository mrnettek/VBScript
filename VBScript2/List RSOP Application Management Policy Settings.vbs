' Description: Returns information about application management extension policies assigned to a computer by using Group Policy. To return information about Group Policy applied to the logged-on user, change the WMI class from root\rsop\computer to root\rsop\user.
