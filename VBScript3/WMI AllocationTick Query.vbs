...
For Each strComputer In arrComputers
   ...
   Set colItems = objWMIService.ExecQuery("SELECT * FROM AllocationTick", "WQL", _
                                          wbemFlagReturnImmediately + wbemFlagForwardOnly)

   For Each objItem In colItems
      WScript.Echo "Allocation: " & objItem.Allocation
      WScript.Echo "AllocationKind: " & objItem.AllocationKind
