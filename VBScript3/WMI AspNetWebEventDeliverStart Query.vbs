...
For Each strComputer In arrComputers
   ...
   Set colItems = objWMIService.ExecQuery("SELECT * FROM AspNetWebEventDeliverStart", "WQL", _
                                          wbemFlagReturnImmediately + wbemFlagForwardOnly)

   For Each objItem In colItems
      WScript.Echo "ConnID: " & objItem.ConnID
      WScript.Echo "ContextId: " & objItem.ContextId
      WScript.Echo "EventGroupName: " & objItem.EventGroupName
      ...
      WScript.Echo "RuleName: " & objItem.RuleName
