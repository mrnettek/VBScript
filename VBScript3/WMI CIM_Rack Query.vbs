...
Set colItems = objWMIService.ExecQuery("Select * from CIM_Rack",,48)
For Each objItem in colItems
    ...
    Wscript.Echo "CountryDesignation: " & objItem.CountryDesignation
    ...
    Wscript.Echo "TypeOfRack: " & objItem.TypeOfRack
