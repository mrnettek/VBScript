...
For Each strComputer In arrComputers
   ...
   Set colItems = objWMIService.ExecQuery("SELECT * FROM DiskIo_TypeGroup1", "WQL", _
                                          wbemFlagReturnImmediately + wbemFlagForwardOnly)

   For Each objItem In colItems
      WScript.Echo "ByteOffset: " & objItem.ByteOffset
      ...
      WScript.Echo "FileObject: " & objItem.FileObject
      WScript.Echo "Flags: " & objItem.Flags
      WScript.Echo "InstanceId: " & objItem.InstanceId
      WScript.Echo "IrpFlags: " & objItem.IrpFlags
      ...
      WScript.Echo "QueueDepth: " & objItem.QueueDepth
      ...
      WScript.Echo "TransferSize: " & objItem.TransferSize
