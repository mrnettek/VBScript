...
For Each strComputer In arrComputers
   ...
   Set colItems = objWMIService.ExecQuery("SELECT * FROM HWConfig_LogDisk", "WQL", _
   ...
   For Each objItem In colItems
      ...
      WScript.Echo "PartitionSize: " & objItem.PartitionSize
      WScript.Echo "ReservedHeaderField: " & objItem.ReservedHeaderField
      WScript.Echo "StartOffset: " & objItem.StartOffset
