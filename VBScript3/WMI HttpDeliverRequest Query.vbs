...
For Each strComputer In arrComputers
   ...
   Set colItems = objWMIService.ExecQuery("SELECT * FROM HttpDeliverRequest", "WQL", _
                                          wbemFlagReturnImmediately + wbemFlagForwardOnly)

   For Each objItem In colItems
      WScript.Echo "AppPoolName: " & objItem.AppPoolName
      ...
      WScript.Echo "RequestId: " & objItem.RequestId
      WScript.Echo "RequestObj: " & objItem.RequestObj
      WScript.Echo "ReservedHeaderField: " & objItem.ReservedHeaderField
      WScript.Echo "SiteId: " & objItem.SiteId
