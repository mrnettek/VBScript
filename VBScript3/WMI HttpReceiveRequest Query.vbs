...
For Each strComputer In arrComputers
   ...
   Set colItems = objWMIService.ExecQuery("SELECT * FROM HttpReceiveRequest", "WQL", _
                                          wbemFlagReturnImmediately + wbemFlagForwardOnly)

   For Each objItem In colItems
      WScript.Echo "AddressType: " & objItem.AddressType
      ...
      WScript.Echo "IpAddr: " & objItem.IpAddr
