...
For Each strComputer In arrComputers
   ...
   Set colItems = objWMIService.ExecQuery("SELECT * FROM MSMCAInfo_RawCorrectedPlatformEvent", "WQL", _
   ...
   For Each objItem In colItems
      ...
      strRecords = Join(objItem.Records, ",")
         WScript.Echo "Records: " & strRecords
