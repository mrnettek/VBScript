...
For Each strComputer In arrComputers
   ...
   Set colItems = objWMIService.ExecQuery("SELECT * FROM ModuleLoadUnLoad", "WQL", _
                                          wbemFlagReturnImmediately + wbemFlagForwardOnly)

   For Each objItem In colItems
      WScript.Echo "AssemblyId: " & objItem.AssemblyId
      ...
      WScript.Echo "ModuleFlags: " & objItem.ModuleFlags
      WScript.Echo "ModuleId: " & objItem.ModuleId
      WScript.Echo "ModuleILPath: " & objItem.ModuleILPath
      WScript.Echo "ModuleNativePath: " & objItem.ModuleNativePath
