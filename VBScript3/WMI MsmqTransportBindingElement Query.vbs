...
For Each strComputer In arrComputers
   ...
   Set colItems = objWMIService.ExecQuery("SELECT * FROM MsmqTransportBindingElement", "WQL", _
   ...
   For Each objItem In colItems
      ...
      WScript.Echo "UseActiveDirectory: " & objItem.UseActiveDirectory
