...
For Each strComputer In arrComputers
   ...
   Set colItems = objWMIService.ExecQuery("SELECT * FROM PageFault_TransitionFault", "WQL", _
   ...
   For Each objItem In colItems
      ...
      WScript.Echo "ProgramCounter: " & objItem.ProgramCounter
      ...
      WScript.Echo "VirtualAddress: " & objItem.VirtualAddress
      WScript.Echo
   Next
Next
