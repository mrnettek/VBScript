...
For Each strComputer In arrComputers
   ...
   Set colItems = objWMIService.ExecQuery("SELECT * FROM Process_TypeGroup1", "WQL", _
   ...
   For Each objItem In colItems
      ...
      WScript.Echo "ExitStatus: " & objItem.ExitStatus
      WScript.Echo "Flags: " & objItem.Flags
      WScript.Echo "ImageFileName: " & objItem.ImageFileName
      ...
      WScript.Echo "ParentId: " & objItem.ParentId
