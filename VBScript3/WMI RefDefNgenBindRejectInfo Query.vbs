...
For Each strComputer In arrComputers
   ...
   Set colItems = objWMIService.ExecQuery("SELECT * FROM RefDefNgenBindRejectInfo", "WQL", _
                                          wbemFlagReturnImmediately + wbemFlagForwardOnly)

   For Each objItem In colItems
      WScript.Echo "DefModuleName: " & objItem.DefModuleName
      ...
      WScript.Echo "RefModuleName: " & objItem.RefModuleName
      WScript.Echo "RejectReason: " & objItem.RejectReason
