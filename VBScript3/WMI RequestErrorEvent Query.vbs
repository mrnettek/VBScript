...
For Each strComputer In arrComputers
   ...
   Set colItems = objWMIService.ExecQuery("SELECT * FROM RequestErrorEvent", "WQL", _
   ...
   For Each objItem In colItems
      ...
      WScript.Echo "ExceptionMessage: " & objItem.ExceptionMessage
      WScript.Echo "ExceptionType: " & objItem.ExceptionType
      WScript.Echo "IsImpersonating: " & objItem.IsImpersonating
      ...
      WScript.Echo "StackTrace: " & objItem.StackTrace
      WScript.Echo "ThreadAccountName: " & objItem.ThreadAccountName
