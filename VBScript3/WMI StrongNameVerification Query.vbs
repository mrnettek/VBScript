...
For Each strComputer In arrComputers
   ...
   Set colItems = objWMIService.ExecQuery("SELECT * FROM StrongNameVerification", "WQL", _
                                          wbemFlagReturnImmediately + wbemFlagForwardOnly)

   For Each objItem In colItems
      WScript.Echo "ErrorCode: " & objItem.ErrorCode
      ...
      WScript.Echo "FullyQualifiedAssemblyName: " & objItem.FullyQualifiedAssemblyName
      ...
      WScript.Echo "VerificationFlags: " & objItem.VerificationFlags
      WScript.Echo
   Next
Next
