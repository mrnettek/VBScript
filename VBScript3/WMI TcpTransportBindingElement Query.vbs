...
For Each strComputer In arrComputers
   ...
   Set colItems = objWMIService.ExecQuery("SELECT * FROM TcpTransportBindingElement", "WQL", _
   ...
   For Each objItem In colItems
      ...
      WScript.Echo "ListenBacklog: " & objItem.ListenBacklog
      ...
      WScript.Echo "PortSharingEnabled: " & objItem.PortSharingEnabled
      WScript.Echo "Scheme: " & objItem.Scheme
      WScript.Echo "TeredoEnabled: " & objItem.TeredoEnabled
