...
For Each strComputer In arrComputers
   ...
   Set colItems = objWMIService.ExecQuery("SELECT * FROM TerminateIOThread", "WQL", _
   ...
   For Each objItem In colItems
      ...
      WScript.Echo "IOThreadCount: " & objItem.IOThreadCount
      ...
      WScript.Echo "RetiredIOs: " & objItem.RetiredIOs
