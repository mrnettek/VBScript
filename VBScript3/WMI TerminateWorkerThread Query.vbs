...
For Each strComputer In arrComputers
   ...
   Set colItems = objWMIService.ExecQuery("SELECT * FROM TerminateWorkerThread", "WQL", _
   ...
   For Each objItem In colItems
      ...
      WScript.Echo "RetiredWorkers: " & objItem.RetiredWorkers
      ...
      WScript.Echo "WorkerThreadCount: " & objItem.WorkerThreadCount
      WScript.Echo
   Next
Next
