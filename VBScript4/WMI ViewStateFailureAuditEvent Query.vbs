...
For Each strComputer In arrComputers
   ...
   Set colItems = objWMIService.ExecQuery("SELECT * FROM ViewStateFailureAuditEvent", "WQL", _
   ...
   For Each objItem In colItems
      ...
      WScript.Echo "PersistedState: " & objItem.PersistedState
      WScript.Echo "ProcessID: " & objItem.ProcessID
      WScript.Echo "ProcessName: " & objItem.ProcessName
      WScript.Echo "Referer: " & objItem.Referer
      ...
      WScript.Echo "UserAgent: " & objItem.UserAgent
      ...
      WScript.Echo "ViewStateExceptionMessage: " & objItem.ViewStateExceptionMessage
      WScript.Echo
   Next
Next
